        ...
        var gosti = [
            {
                id: 1,
                ime: "Andrej Radinger ",
                img: "img/rad_slika1.jpg",
                bigImg: "img/rad_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Četvrtak 22.05. — 13.00 - 14.00 h"
                }
            },
            {
                id: 2,
                ime: "NanovoGroup",
                img: "img/nano_slika1.jpg",
                bigImg: "img/nano_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Četvrtak 22.05. — 16.10 — 17.00 h",
            ...
            },
            {
                id: 3,
                ime: "Andrej Lončarić",
                img: "img/andrej_slika1.jpg",
                bigImg: "img/andrej_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Četvrtak 22.05. — 17.10 — 17.50 h"
                }
            },
            {
                id: 4,
                ime: "Filip Dizdar",
                img: "img/dizdar_slika1.jpg",
                bigImg: "img/dizdar_slika2.jpg",
                ...
                predavanje: {
                    type: "Predavanje",
                    naslov: "Music Production Academy",
                    datum: "Četvrtak 22.05. — 18.00 — 18.40 h"
                }
            },
            {
                id: 5,
                ime: "Vladimir Končar",
                img: "img/vlado_slika1.jpg",
                bigImg: "img/vlado_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Četvrtak 22.05. — 20.00 — 20.45 h",
            ...
            },
            {
                id: 6,
                ime: "DAN D",
                img: "img/dand_slika1.jpg",
                bigImg: "img/dand_slika2.jpg",
                ...
                ,predavanje: {
                    ...
                    datum: "Četvrtak 22.05. — 20.45 — 21.15 h"
                }
            },
            {
                id: 7,
                ime: "Perica Šuran",
                img: "img/perica_slika1.jpg",
                bigImg: "img/perica_slika2.jpg",
                ...
                predavanje: {
                    type: "Predavanje",
                    naslov: "In the box",
                    datum: "Petak 23.05. — 17.00 — 17.50 h",
            ...
            },
            {
                id: 32,
                ime: "Unity",
                img: "img/unity_slika1.jpg",
                bigImg: "img/unity_slika2.jpg",
                bio: "Unity je tim koji se bavi kreiranjem interaktivnih proizvoda(mobile/web/whatever) i eksperimentiranjem na području UI/UX dizajna. Uglavnom radimo sa startupima, tako da sudjelujemo u svim fazama razvoja projekta - od razvoja samog koncepta i identiteta, preko kreiranja prvih prototipa, pa do razvoja proizvoda spremnih za tržište."
                ,links: ["www.unity.hr","www.dribbble.com/UnityInteractive","www.behance.net/UnityInteractive"],
                predavanje: {
                    type: "Predavanje",
                    naslov: "Share or Die",
                    datum: "Petak 23.05. — 18.00 — 18.30 h",
                    opis: "Zašto je open source tako super stvar i zašto mislimo da bi sve trebalo biti otvoreno? Na temelju malog dizajn eksperimenta kojeg smo napravili prije mjesec dana ćemo pokazati direktan utjecaj otvorenosti."
                }
            },
            {
                id: 8,
                ime: "Ivan Mesek",
                img: "img/mesek_slika1.jpg",
                bigImg: "img/mesek_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Petak 23.05. — 18.30 — 18.50 h",
                }
            },
            {
                id: 9,
                ime: "Mireldy",
                img: "img/mireldy_slika1.jpg",
                bigImg: "img/mireldy_slika2.jpg",
                ...
                predavanje: {
                    type: "Predavanje",
                    naslov: "Mireldy",
                    datum: "Petak 23.05. — 18.50 — 19.10 h",
                    opis: " Kroz presjek radova koji su nastali u zadnjih 10 godina našeg zajedničkog djelovanja, pokazat ćemo kako smo se razvijali, mijenjali te na koji način smo kao dizajneri reagirali na zbivanja oko nas i izazove na koje smo nailazili."
                }
            },
            {
                id: 10,
                ime: "Đukićpavlović",
                img: "img/duk_slika1.jpg",
                bigImg: "img/duk_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Petak 23.05. — 19.20 — 19.40 h",
            ...
            },
            {
                id: 11,
                ime: "Tin Kadoić",
                img: "img/tin_slika1.jpg",
                bigImg: "img/tin_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Petak 23.05. — 19.45 — 20.05 h",
            ...
            },
            {
                id: 12,
                ime: "Marko Hrastovec",
                img: "img/marko_slika1.jpg",
                bigImg: "img/marko_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Petak 23.05. — 20.10 — 20.30 h",
            ...
            },
            {
                id: 14,
                ime: "VUDU",
                img: "img/vudu_slika1.jpg",
                bigImg: "img/vudu_slika2.jpg",
                ...
                predavanje: {
                    type: "Predavanje",
                    naslov: "XFO WORKSHOP",
                    datum: "Subota 24.05. — 11.00 — 13.30 h",
            ...
            },
            {
                id: 15,
                ime: "Gordon Cindrić",
                img: "img/gordon_slika1.jpg",
                bigImg: "img/gordon_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 10.15 — 11.00 h",
                    opis: "Predavanje će se pozabaviti temom razvoja aplikacija za mobilne platforme koristeći dobro poznate i široko korištene web tehnologije: HTML, CSS i JavaScript. Povezati ćemo navedene tehnologije s PhoneGap/Apache Cordova platformom koja nudi mogućnost izrade aplikacija za mobilne uređaje po principu 'jedan kod - sve platforme'. Pridružite nam se i naučite iskoristiti znanja i vještine koje već poznajete za stvaranje višeplatformskih mobilnih aplikacija."
                }
            },
            {
                id: 16,
                ime: "Clover Studio",
                img: "img/clover_slika1.jpg",
                bigImg: "img/clover_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 11.00 — 11.45 h",
            ...
            },
            {
                id: 17,
                ime: "Bold-Studio",
                img: "img/bold_slika1.jpg",
                bigImg: "img/bold_slika2.jpg",
            ...
            },
            {
                ...
                img: "img/booqua_slika1.jpg",
                bigImg: "img/boouqa_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 13.00 — 13.30 h"
                }
            },
            {
                id: 33,
            ...
            },
            {
                ...
                img: "img/sandro_2.jpg",
                bigImg: "img/sandro_1.jpg",
            ...
            },
            {
                ...
                img: "img/oleg_slika1.jpg",
                bigImg: "img/oleg_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 18.25 — 18.45 h"
                }
            },
            {
                id: 21,
                ime: "Gregor Žakelj",
                img: "img/zakelj_slika1.jpg",
                bigImg: "img/zakelj_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 18.50 — 19.35 h",
            ...
            },
            {
                id: 22,
                ime: "Ivica Mitrović",
                img: "img/mitrovic_slika1.jpg",
                bigImg: "img/mitrovic_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05 — 19.40 — 20.10 h",
            ...
            },
            {
                id: 23,
                ime: "Vibor Cipan",
                img: "img/vibor_slika1.jpg",
                bigImg: "img/vibor_slika2.jpg",
                ...
                predavanje: {
                    ...
                    datum: "Subota 24.05. — 20.15 — 20.35 h",
            ...
            },
            {
                id: 24,
                ime: "Nikola Kovač",
                img: "img/kovac_slika1.jpg",
                bigImg: "img/kovac_slika2.jpg",
            ...
            },
            {
                id: 25,
                ime: "BADco",
                img: "img/badco_slika_1.jpg",
                bigImg: "img/badco_slike_2.jpg",
            ...
            },
            {
                ...
                img: "img/fat_slika1.jpg",
                bigImg: "img/fat_slika2.jpg",
            ...
            },
            {
                ...
                img: "img/motovunski_slika1.jpg",
                bigImg: "img/motovunski_slika2.jpg",
            ...
            },
            {
                id: 28,
                ime: "DMT",
                img: "img/dmt_slika1.jpg",
                bigImg: "img/dmt_slika2.jpg",
                ...
                ,links: ["www.facebook.com/davidtesic","soundcloud.com/djdmt","mixcloud.com/davidtesic"]
            },
            {
                id: 29,
                ime: "MC BIG OZ",
                img: "img/bigoz_slika1.jpg",
                bigImg: "img/bigoz_slika2.jpg",
            ...
            },
            {
                id: 30,
                ime: "Šalter",
                img: "img/salter_slika3.jpg",
                bigImg: "img/salter_slika1.jpg",
            ...
            },
            {
                id: 31,
                ime: "Mixel",
                img: "img/mixel_slika1.jpg",
                bigImg: "img/mixel_slika2.jpg",
