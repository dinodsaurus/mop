    ...
    .factory("predavaciFac", function () {
        ...
        var gosti = [
            ...
            },
            {
                ...
                ime: "Kotam",
                img: "img/mesek.jpg",
                bigImg: "img/mesek.jpg"
                ,links: [],
                predavanje: {
                    type: "Party",
                    datum: "Petak 23.04 | 23.00 — 04.00 h"
                }
            },
            {
                id: 14,
                ...
                predavanje: {
                    type: "Predavanje",
                    naslov: "XFO WORKSHOP",
                    datum: "Subota 24.04 | 11.00 — 15.00 h",
            ...
            },
            {
                ...
                ,links: ["http://www.nakonjusmo.net/"],
                predavanje: {
                    type: "Predavanje",
                    naslov: "Na konju smo .net",
                    datum: "Subota 24.04 | 18.24 — 18.45 h"
                }
            },
            {
                id: 21,
            ...
            },
            {
                ...
                predavanje: {
                    ...
                    naslov: "Projektor.hr",
                    datum: "Subota 24.04 | 20.15 — 20.35 h",
                    opis: "platforma za prezentaciju i financiranje kreativnih i umjetničkih projekata"
                }
            },
            {
                id: 25,
